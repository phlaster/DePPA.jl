...
@testset "Show Methods for Oligos" begin
    ...
    @test occursin(
        "DegenOligo(\"ACGTN\", len=5, n_deg=1, vars=4, desc=\"desc2\")",
        sprint(show, d),
    )
    @test occursin(
        "Degenerate positions: 1",
        sprint((io, x) -> show(io, MIME"text/plain"(), x), d),
    )
    @test occursin(
        "Unique variants: 4",
        sprint((io, x) -> show(io, MIME"text/plain"(), x), d),
    ...
    @test occursin(
        "Gapped sequence: A-C-G",
        sprint((io, x) -> show(io, MIME"text/plain"(), x), g),
    )
    @test occursin(
        "Length (with gaps): 5",
        sprint((io, x) -> show(io, MIME"text/plain"(), x), g),
    ...
    @test occursin(
        "Viewed sequence: CGT",
        sprint((io, x) -> show(io, MIME"text/plain"(), x), v),
    )
